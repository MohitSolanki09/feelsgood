        ...
        <section className="relative overflow-hidden bg-white">
            <div className="mx-auto max-w-[1600px] px-5">
                ...
                <div className="grid min-h-[285px] grid-cols-[1.2fr_0.8fr] border-x border-[#e7e1d7] max-lg:grid-cols-1">
                    {/* Left Content */}
                    <div className="hero-heading-panel flex items-center border-r border-[#e7e1d7] px-10 py-14 max-lg:border-r-0 max-lg:border-b max-md:px-5 max-md:py-10">
                        <div className="hero-copy">
                            <p className="hero-eyebrow mb-6 flex items-center gap-2 text-[18px] font-medium tracking-[-0.4px] text-[#0B1F35] max-md:text-[16px]">
                                <span className="text-[#D79229]">/</span>
                                About
                            </p>

                            <h1 className="hero-title max-w-[760px] text-[64px] font-extrabold uppercase leading-[1.12] tracking-[-2.5px] text-[#050505] max-2xl:text-[58px] max-xl:text-[50px] max-md:text-[40px] max-sm:text-[32px]">
