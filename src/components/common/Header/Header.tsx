...
//                 { label: "Export Market", href: "/exports" },
...
//         href: "/solutions",
//         mega: {
//             title: "Custom Brass Solutions For Modern Industries",
...
//                 { label: "Sanitary", href: "/industries/sanitary" },
//                 { label: "Agriculture", href: "/industries/agriculture" },
//                 { label: "OEM Parts", href: "/solutions/oem-parts" },
//             ],
//         },
//     },
//     {
...
//             ctaHref: "/products",
//             links: [
//                 { label: "Brass Inserts", href: "/products/brass-inserts" },
//                 { label: "Brass Fittings", href: "/products/brass-fittings" },
//                 { label: "Brass Fasteners", href: "/products/brass-fasteners" },
//                 { label: "Brass Electrical Parts", href: "/products/brass-electrical-parts" },
//                 { label: "Brass Sanitary Parts", href: "/products/brass-sanitary-parts" },
//                 { label: "CNC Brass Parts", href: "/products/cnc-brass-parts" },
//                 { label: "Brass Turned Parts", href: "/products/brass-turned-parts" },
//                 { label: "Custom Brass Parts", href: "/products/custom-brass-parts" },
//             ],
//         },
//     },
...
// function Logo() {
//     return (
//         <Link href="/" className="relative block h-[58px] w-[250px] max-md:w-[210px] max-sm:w-[180px]">
//             <Image
//                 src={logo}
...
//     return (
//         <div className="invisible fixed left-0 right-0 top-[104px] z-40 translate-y-3 border-b border-[#e7e1d7] bg-white opacity-0 shadow-[0_25px_70px_rgba(11,31,53,0.12)] transition-all duration-300 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100">
//             <div className="mx-auto grid max-w-[1360px] grid-cols-[330px_1px_1fr_385px] gap-14 px-10 py-7">
//                 <div className="flex min-h-[260px] flex-col justify-center">
//                     <h3 className="max-w-[280px] text-[28px] font-black uppercase leading-[1.12] tracking-[-1px] text-[#0B1F35]">
//                         {menu.title}
//                     </h3>

//                     <Link
//                         href={menu.ctaHref}
//                         className="mt-10 inline-flex w-fit items-center gap-5 border-b border-[#D79229] pb-1 text-[14px] font-black uppercase tracking-[4px] text-[#0B1F35] transition-colors duration-300 hover:text-[#D79229]"
//                     >
//                         View All
//                         <ArrowIcon />
//                     </Link>
...
//                     <div className="grid w-full grid-cols-3 gap-x-12 gap-y-5">
//                         {menu.links.map((link) => (
//                             <Link
//                                 key={link.label}
//                                 href={link.href}
//                                 className="text-[20px] font-medium tracking-[-0.5px] text-[#0B1F35] transition-all duration-300 hover:translate-x-1 hover:text-[#D79229]"
//                             >
//                                 {link.label}
//                             </Link>
//                         ))}
...
//                 <div className="flex items-center">
//                     <Link href={menu.ctaHref} className="group/card relative block h-[288px] w-full overflow-hidden bg-[#F8F3EA]">
//                         <Image
//                             src={menu.image}
//                             alt={menu.cta}
//                             fill
...
//                         <div className="absolute bottom-0 left-0 right-0 flex h-[73px] items-center justify-between bg-[#0B1F35] px-9 text-white">
//                             <span className="text-[16px] font-black uppercase tracking-[3px]">{menu.cta}</span>
//                             <ArrowIcon />
//                         </div>
//                     </Link>
//                 </div>
...
// function SearchPanel({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
//     return (
//         <div
//             className={`fixed right-0 top-[104px] z-[70] w-[640px] bg-[#F8F3EA] px-10 py-5 shadow-[0_15px_45px_rgba(11,31,53,0.12)] transition-all duration-300 max-lg:left-0 max-lg:w-full max-sm:px-5 ${isOpen ? "translate-y-0 opacity-100" : "pointer-events-none -translate-y-4 opacity-0"
//                 }`}
//         >
...
//                     className="h-[62px] flex-1 bg-white px-6 text-[16px] text-[#0B1F35] outline-none placeholder:text-[#465566]"
//                 />
...
//             <aside
//                 className={`fixed right-0 top-0 z-[90] h-screen w-[680px] overflow-y-auto bg-white transition-transform duration-500 max-md:w-[88vw] ${isOpen ? "translate-x-0" : "translate-x-full"
//                     }`}
//             >
//                 <div className="relative min-h-screen px-[90px] pb-0 pt-12 max-md:px-8">
//                     <button
//                         type="button"
//                         onClick={onClose}
//                         aria-label="Close menu"
//                         className="absolute right-12 top-12 flex h-12 w-12 items-center justify-center text-[#0B1F35] transition-colors duration-300 hover:text-[#D79229] max-md:right-6"
//                     >
//                         <CloseIcon />
//                     </button>

//                     <div className="relative mb-12 h-[95px] w-[330px] max-sm:w-[250px]">
//                         <Image
...
//                     <div className="mb-7 flex items-center gap-2 text-[21px] text-[#465566]">
//                         <span className="text-[#D79229]">/</span>
//                         <span>Contact us</span>
//                     </div>

//                     <h2 className="mb-8 text-[44px] font-black uppercase leading-[1.15] tracking-[-1.5px] text-[#0B1F35] max-md:text-[32px]">
//                         Feel Good <br />
//                         Brass Industry
//                     </h2>

//                     <div className="space-y-8 text-[20px] leading-[1.45] text-[#465566] max-md:text-[18px]">
//                         <p>
//                             Jamnagar, Gujarat <br />
//                             India
//                         </p>
...
//                     <nav className="mt-14 grid gap-4 border-t border-[#e7e1d7] pt-8">
//                         {navItems.map((item) => (
//                             <Link
//                                 key={item.label}
//                                 href={item.href}
//                                 onClick={onClose}
//                                 className="text-[16px] font-black uppercase tracking-[3px] text-[#0B1F35] transition-colors duration-300 hover:text-[#D79229]"
//                             >
//                                 {item.label}
//                             </Link>
//                         ))}
...
//                     href="/contact"
//                     onClick={onClose}
//                     className="sticky bottom-0 flex h-[84px] w-full items-center justify-center gap-3 bg-[#0B1F35] text-[18px] font-black uppercase tracking-[3px] text-white transition-colors duration-300 hover:bg-[#D79229]"
//                 >
//                     Get In Touch
//                     <ArrowIcon />
//                 </Link>
...
//     return (
//         <>
//             <header className="sticky top-0 z-50 h-[104px] border-b border-[#e7e1d7] bg-white">
//                 <div className="flex h-full items-stretch">
//                     <div className="flex w-[360px] items-center pl-10 max-xl:w-[280px] max-lg:w-auto max-lg:flex-1 max-md:pl-5">
//                         <Logo />
//                     </div>

//                     <nav className="hidden flex-1 items-center justify-center gap-9 xl:flex">
//                         {navItems.map((item) => (
//                             <div key={item.label} className="group flex h-full items-center">
//                                 <Link
//                                     href={item.href}
//                                     className={`relative flex h-full items-center text-[14px] font-black uppercase tracking-[4px] transition-colors duration-300 ${item.active ? "text-[#D79229]" : "text-[#0B1F35] group-hover:text-[#D79229]"
//                                         }`}
//                                 >
//                                     <span
//                                         className={`absolute left-0 top-0 h-[3px] w-full bg-[#D79229] transition-transform duration-300 ${item.active ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"
//                                             }`}
//                                     />
//                                     {item.label}
//                                 </Link>
...
//                                 setSideOpen(false);
//                             }}
//                             className="hidden w-[92px] items-center justify-center border-l border-[#e7e1d7] text-[#0B1F35] transition-colors duration-300 hover:text-[#D79229] lg:flex"
//                         >
//                             <SearchIcon />
//                         </button>
...
//                                 setSearchOpen(false);
//                             }}
//                             className="flex w-[102px] items-center justify-center bg-[#D79229] transition-colors duration-300 hover:bg-[#0B1F35] max-md:w-[78px]"
//                         >
//                             <GridIcon />
//                         </button>
//                     </div>
...
const navItems: NavItem[] = [
    ...
    //             { label: "Brass Fasteners", href: "/products/brass-fasteners" },
    //             {
    //                 label: "Brass Electrical Parts",
    //                 href: "/products/brass-electrical-parts",
    //             },
    //             {
    //                 label: "Brass Sanitary Parts",
    //                 href: "/products/brass-sanitary-parts",
    //             },
    //             { label: "CNC Brass Parts", href: "/products/cnc-brass-parts" },
    //             { label: "Brass Turned Parts", href: "/products/brass-turned-parts" },
    //             { label: "Custom Brass Parts", href: "/products/custom-brass-parts" },
    ...
    // },
    {
        ...
        mega: {
            ...
            links: [
                ...
                {
                    label: "CNC Turned Components",
                    href: "/products/cnc-turned-components",
                },
                {
                    label: "Custom Brass Components",
